---
description: Vue/TypeScript code review launcher. Use within @code-reviewer; loads project review guidance through AGENTS.md.
agent: ask
---
...
3. Load only the frontend review spec file listed there for this Vue/TypeScript review scope.
4. Use that review spec as the Vue/TypeScript-specific checklist.
